package com.example.todell.Database.databases

import androidx.room.Database
import androidx.room.RoomDatabase
import com.example.todell.Database.Daos.ListDao
...
/***
 * Database
The following code defines an InventoryDatabase class to hold the database.
InventoryDatabase defines the database configuration and serves as the app's main access point to the persisted data.
 ...
 * */
@Database(entities = [TodellModel::class,TodellModelTask::class],version = 5)
